  ...
  return (
    <Bounded className="py-12">
      <div className="grid grid-cols-1 items-center gap-10 pb-10 lg:grid-cols-2">
        <div className="relative mt-14 flex justify-center pb-10">
          <PrismicNextImage
            field={page.data.bottle_image}
            width={600}
            height={600}
            priority
            className="mask-fade-bottom absolute top-[90%] -scale-y-100"
          />
          <PrismicNextImage
            field={page.data.bottle_image}
            width={600}
        ...
        <div className="text-white">
          ...
          <div className="space-y-6">
            <p className="text-md font-semibold">Eau da Parfum Spray</p>
            <PrismicRichText field={page.data.description} />
            <FragranceAttributes
              mood={page.data.mood ?? "bold"}
...
export async function generateMetadata({
  ...
  return {
    title: asText(page.data.title) + " | Cote Royale Paris",
